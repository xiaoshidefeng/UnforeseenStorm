...
public class Sunny implements Weather {
    ...
    public void weather(Context context, ImageView imageView, CollapsingToolbarLayout collapsingToolbarLayout, RealWeatherBean realWeatherBean) {
        ...
        //修改Bar颜色
        collapsingToolbarLayout.setStatusBarScrimColor(ContextCompat.getColor(context, R.color.colorSunny));
        collapsingToolbarLayout.setContentScrimColor(ContextCompat.getColor(context, R.color.colorSunny));
    }
}
